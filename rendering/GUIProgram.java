...
public class GUIProgram {
    ...
    private ArrayList<GUIShader> shaders;

    public String programName;

    private final Map<String,Integer> uniforms;

    public GUIProgram() throws Exception {
        this("");
    }

    public GUIProgram(String name) throws Exception{
    ...
    public void attachShaders(GUIShader[] shaders){
        for(GUIShader shader:shaders){
